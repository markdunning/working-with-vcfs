...
- What part of the output are altered?
...
`bedtools` has some useful tools for overlapping various types of genomic intervals

```{}
bedtools intersect -header -a NA12878.chr20.freebayes.vcf -b NA12878.chr20.broad_truth_set.20131119.snps_and_indels.genotypes.vcf.gz > NA12878.chr20.freebayes.validated.vcf
```

```{}
bedtools intersect -header -a NA12878.chr20.broad_truth_set.20131119.snps_and_indels.genotypes.vcf.gz -b NA12878.chr20.freebayes.vcf -v > NA12878.chr20.freebayes.missing.vcf
```
...
```{}
bedtools intersect -header -a NA12878.chr20.freebayes.vcf -b exons.chr20.bed > NA12878.chr20.exonic.freebayes.vcf
```
...
myvcf <- readVcf("NA12878.chr20.1MB.freebayes.vcf","hg19")
